            ...
            Expanded(
              child: ListView(
                ...
                children: <Widget>[
                  ...
                  const SizedBox(height: 16),
                  const _SettingsHeader(title: 'Codegen'),
                  AutoGenerateDictionaryListTile(workspaceController: workspaceController),
                  const SizedBox(height: 16),
...
class AutoGenerateDictionaryListTile extends StatelessWidget {
  const AutoGenerateDictionaryListTile({
    super.key,
    required this.workspaceController,
  });
  ...
  Widget build(BuildContext context) {
    ...
    final enabled = meta?.autoGenerateDictionary ?? true;

    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 12),
      child: SwitchListTile(
        value: enabled,
        onChanged: meta == null ? null : (value) => workspaceController.setAutoGenerateDictionary(value),
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
        title: const Text('Auto-generate Dictionary'),
        subtitle: const Text('Regenerate dictionary.dart when keys change'),
        secondary: Icon(
