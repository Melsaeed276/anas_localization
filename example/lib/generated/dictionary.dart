...
class Dictionary extends base.Dictionary {
  ...
  /// Get localized text for "app_title"
  String get appTitle2 => getString('app_title');
  ...
  String itemsCount({required num count}) {
    ...
    dynamic template;
    final form = count.abs() == 1 ? 'one' : 'other';
    template = pluralMap[form] ?? pluralMap['other'] ?? pluralMap.values.first;
    return template.toString().replaceAll('{count}', count.toString());
  }
